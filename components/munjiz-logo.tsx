...
interface MunjizLogoProps {
  className?: string;
  iconSize?: number;
  textSize?: "sm" | "md" | "lg" | "xl";
}

export function MunjizLogo({
  className,
  iconSize = 32,
  textSize = "lg",
}: MunjizLogoProps) {
  ...
  return (
    <div className={cn("flex items-center gap-3", className)}>
      {/* SVG Logo Icon - Themed with Munjiz colors */}
      <svg
        viewBox="0 0 30 30"
        width={iconSize}
        height={iconSize}
      ...
      >
        {/* Path 1: Teal (Secondary) - Bottom layer */}
        <path
        ...
        {/* Path 2: Gold/Orange Accent (Center) - Middle layer */}
        <path
        ...
        {/* Path 3: Violet (Primary) - Top layer */}
        <path
